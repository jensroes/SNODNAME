/*
  Auto regression model (first order): autoregression component is phi
  Random intercepts for subject and images
  Multilevel for intercept and slopes separated by pre-onset and post-onset
  Thus all effects are estimated separatey for before and after onset
*/
