...
#---- 
# Load model
ar1 <- stan_model(file = "stanin/ARspell2MoG3.stan")
...
# Save model
saveRDS(m, 
        file = "stanout/ARspell2MoG3.rda",
        compress = "xz")

# Traceplots
#names(m)
param <- c("alpha", "b_spell", "delta", "theta", "phi", "sigma", "alpha_mu", "alpha_sigma", "alpha_raw", "sigma_diff", "sigma_e", "sigmap_e") 
