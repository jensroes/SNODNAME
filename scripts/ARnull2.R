...
#---- 
# Load model
ar1 <- stan_model(file = "stanin/ARnull2.stan")
...
# Save model
saveRDS(m, 
        file = "stanout/ARnull2.rda",
        compress = "xz")

# Traceplots
#m <- loadRDS(file = "stanout/ARnull2.rda")

#names(m)
param <- c("alpha", "phi", "sigma", "alpha_mu", "alpha_sigma", "alpha_raw") 
